...
brew trust sondt2709/just-transcribe
...
> `xattr -cr` is not a security threat, the app just is not signed with an Apple certificate yet
...
Go to App Setttings > Reinstall Backend
