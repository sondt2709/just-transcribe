...
Mobile transcription pipeline: coroutine orchestrator from capture through VAD, segmentation, remote ASR, and remote translation, reduced into a single unidirectional UiState flow.
