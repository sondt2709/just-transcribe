...
Getting transcript content out of the KMP Android app: per-row copy, whole-transcript copy, plain-text share/export that mirrors the UI exactly, and clearing.
