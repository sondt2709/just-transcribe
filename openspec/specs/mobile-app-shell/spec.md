...
Kotlin Multiplatform app structure for the Android client: shared module layout, Compose UI shell, settings persistence, foreground service, and Android configuration.
